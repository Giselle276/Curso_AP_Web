                        ...
                        <nav class="navbar bg-body-tertiary">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                              <a href="modificar.php?id_usuario=<?php  echo $reg_row['id_usuario']; ?>" class="btn btn-info">Modificar</a>
                              </td>
                              <td>
                                <form action="code.php" method="POST">
                                  <input type="hidden" name="eliminar_id" value="<?php echo $reg_row['id_usuario']; ?>">
                                  <button type="submit" name="eliminar_btn" class="btn btn-danger">Eliminar</button>
                                </form>
